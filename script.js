...
const UI = {
  zh: {
    ...
    openModule: "打开模块", loadError: "模块加载失败：", pageTitle: "EUPV2026 业务工作台", feedbackEyebrow: "反馈", feedbackTitle: "留言与反馈", feedbackDesc: "发现数据问题、希望增加功能，或只是有一个改进建议，都可以直接告诉我。", feedbackName: "姓名", feedbackEmail: "邮箱（便于回复）", feedbackModule: "相关模块", feedbackModulePortal: "EUPV2026 主页", feedbackModuleSales: "销售分析", feedbackModuleForecast: "销售预测分析", feedbackModuleStock: "可用库存", feedbackModuleShipment: "Shipment Details", feedbackModulePo: "PO 核验", feedbackModuleOdp: "ODP 发运分析", feedbackModuleWeekly: "静态周报", feedbackCategory: "反馈类型", feedbackIdea: "功能建议", feedbackBug: "问题反馈", feedbackData: "数据问题", feedbackOther: "其他", feedbackMessage: "留言内容", feedbackPlaceholder: "请描述你遇到的问题或建议……", feedbackSubmit: "提交反馈", feedbackSending: "正在提交……", feedbackSuccess: "谢谢，反馈已成功发送。", feedbackRequired: "请先填写留言内容。", feedbackFallback: "在线提交暂不可用，请点击这里通过邮件发送。", feedbackFailed: "提交失败，请稍后重试。", footerNote: "为日常业务清晰而设计。"
  },
  en: {
...
const MODULE_I18N = {
  ...
  "./modules/forecast/forecast-analysis.html": {
...
const ICONS = {
  ...
  forecast:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 18V6m0 12h16"/><path d="m7 14 4-4 3 2 5-6"/><circle cx="7" cy="14" r="1"/><circle cx="11" cy="10" r="1"/><circle cx="14" cy="12" r="1"/><circle cx="19" cy="6" r="1"/></svg>',
